...
const Appointment = () => {
  ...
  const { freelancers, currencySymbol } = useContext(AppContext);
  ...
  const fetchFreeInfo = async () => {
    console.log(freeId);
    const freeInfo = freelancers.find((free) => free._id == "doc1");
    setFreeInfo(freeInfo);
    //console.log("freeinfo", freeInfo);
  };
      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            {/**-------------Freelance Info------- name, degree, experience */}
            ...
            <div className="flex items-center gap-2 text-sm mt-1 text-gray-600">
              <p>
                {freeInfo.degree} - {freeInfo.speciality}
              </p>
